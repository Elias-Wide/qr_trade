...
def upgrade() -> None:
    ...
    sa.Column('notice_type', sqlalchemy_utils.types.choice.ChoiceType(NOTIFICATION_TYPE), nullable=False),
...
def downgrade() -> None:
    ...
    sa.Column('notice_type', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
