...
from app.bot.handlers.user_handlers import get_menucallback_data
...
@code_router.message(F.content_type == ContentType.PHOTO, ImgValidationFilter())
async def process_download_code(
    callback: CallbackQuery,
    callback_data: MenuCallBack,
):
    print('fdfd')
